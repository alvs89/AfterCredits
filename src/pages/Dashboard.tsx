      ...
      <section>
        ...
        {recent && recent.length > 0 ? (
          ...
          <div className={cn(
            ...
            <h3 className="text-lg font-bold mb-2 text-white">No entries yet</h3>
            <p className="mb-4">Start building your media library.</p>
            <button onClick={onAdd} className="bg-[#3B82F6] hover:bg-[#2563EB] text-[#0A0B0E] px-6 py-2 rounded font-bold transition-colors text-xs inline-flex items-center gap-2">
              Add First Entry
            </button>
          </div>
        )}
